...
- Inputs: EEG, original image, ground truth obtained by eye tracking
- Output: Image saliency map and full reconstructed image

Steps:
1. Preprocessing
2. Encoding the EEG and Image data into a same space
3. Training the encoders as a classification problem based on the definition of a compatibility function.
4. 
